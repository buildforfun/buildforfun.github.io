...
#### Markets
Find smallest subeet of market with users that desperately need what you are doing. Go after them.
When there are platform shifts, that's the perfect moment to launch yourself.

What you are good at, what you enjoy, where you can create value?
- I love coding and building. I like building models. I can help others and provide value doing what I enjoy.

the way things get done in the world is through focus, personal connections, and self-belief
...
have a strong opinion then flexible about details. HAVE A STRONG BELIEF.
...
>"The way to get startup ideas is not to try to think of startup ideas. **It's to look for problems, preferably problems you have yourself.** The very best startup ideas tend to have three things in common: they're something the founders themselves want, that they themselves can build, and that few others realise are worth doing. Microsoft, Apple, Yahoo, Google, and Facebook all began this way."  
Paul Graham

### Does my idea need to be a personal pain point?

It’s not a prerequisite to start working on an idea. But it helps. Try manufacturing a car without knowledge of OEMs. Difficult. Not impossible, but difficult indeed. Too much learning about what already exists, not enough time creating a better solution. Intimate knowledge of your problem space is an advantage. It is the basis of "founder-market fit."

>"A thing I believe deeply is that **passion and vision trump knowledge and experience**, and if you've found something you really love that you want to make real, that you can learn...I started reading books on aerodynamics, and I started reading airline annual financial reports to understand the industry. Once I started to realise that this space was more open than it looked, I got really serious about learning."
- Blake Scholl
...
>"You can do whatever you want, once you realise one secret: everything big starts small."
- Daniel Gross
...
### My idea isn't garnering much traction. Should I pivot or persist? Why haven't you gained traction?

If you’ve already launched the product, talked to users, spent months iterating on feedback, and it's clearly not working, pivot. If the reason is outside of your control (hardware adoption, capital constraints, etc.) and you don’t see that changing anytime soon, pivot. If you're no longer excited about the idea, pivot. At the end of the day, your success is tied to your excitement about a problem. Devote time and energy to things you care about. As in writing, it's unlikely that your first draft gets published... be dynamic, shift your solution and talk to users frequently until it works.
...
Daniel Gross, office hours

### Other people are already working on this idea. Should I still work on it?

Blackberry, Friendster, MySpace, IBM. All were first to market. Being first doesn’t matter. Being last matters. The existence of competitors should give you strength. It means you’re working on something that other people think is interesting, too. It also means that you’ll move faster; you have a virtual adversary to match with.
...
## Vision
HAVING A F*CKING DESIRE TO CHANGE A BIG F*CKING WORLD PROBLEM IS THE ONLY REASON TO START A STARTUP!
Clarity about the impact you want to make. 
You need to know about the effect you want to have. 
You need to ask why you’re building, not what you’re building.
Is the world going to be deprived if you don’t fix this problem in the coming five years?
Can’t bear the idea of this idea not living up to its full potential?
Is it really the only thing you can do next?
You CAN’T not work on it. It’s all about keeping going.
If solving a world problem is your reason to start a startup, your odds of success are WAY higher!




# Step 2: Building your product

### Once I have an idea and people to serve, what’s next?

Build an MVP (minimum viable product) and put it in the user's hands. Don't skip this step. The worst thing you can do is build something in isolation for months and learn that it was all for naught. It might turn out that the full thing you want to build isn't what your customers want at all. Don’t be afraid to launch something that feels incomplete. Your goal at this stage is to learn what you don’t know, and the fastest way to do this is to get user feedback.

### When do I launch?

Here's the secret about launching, people. You can launch multiple times. How many here remember the day that Google launched? No. How about Facebook? No. How about Twitter? No. Great. So it turns out – launches aren’t that special at all.

### Which features should I prioritise?

Focus on building a product your users will want. Outside of the conventional wisdom, there is one particularly important piece of advice in the earliest days as a founder: **if you're stuck on how to prioritise, choose projects you're most energised to work on. They'll help you stay motivated.**

Usually, there isn't a right answer. Usually all of the things you want to build won't work. What you need to do is to create a process in your company to build things quickly. Create a culture of working fast and iterating quick.
...
Revenue is also a clear-cut means of determining product/market fit.
...
"At a high level, everyone seems to overcomplicate this product market fit thing. You feel it when you have it." Daniel Gross, office hours

### What are standard metrics I should track?

**User growth, revenue and retention are the big three.** But be extremely careful not to over-index on metrics. Metrics can consume you and lead you astray if you let them. In the same way that you measure the success of your product, you should also step outside your metrics and routinely scrutinise whether or not they're leading you down the correct path of success.
...
Daniel Gross on the Retool story, office hours
...
Make something that people what, and do it in the laziest way possible to get that out for MVP

The goal of a startup is to figure out the right thing to build – the thing customers want and will pay for – as quickly as possible. Customers do not tell us what they want. They reveal the truth through their action or inaction. Test and validate your value and growth hypothesis.
...
Create a Minimum Viable Product (MVP) to validate your idea and gather user feedback. This allows you to iterate and improve your product before a full-scale launch
